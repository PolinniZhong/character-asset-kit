...
以下是用本 Skill 生产的真实角色商卡（两女两男，覆盖真人写实与真人古风两套 profile）。每张商卡包含：主视觉胸像、标准站姿、全身五视图、基础表情、细节特写、道具手持、动作姿态——一张图看清整套资产长什么样。

### 真人写实（现代都市 profile）

**韩东（男，28岁，科技公司产品总监）** — 深灰西装/针织衫，短发利落，真人写实

![韩东角色商卡：主视觉+五视图+表情+细节+道具+动作](docs/images/showcase-handong.png)

**姜书媛（女，26岁，独立咖啡馆主理人）** — 米白针织/驼色大衣，长发微卷，真人写实

![姜书媛角色商卡：主视觉+五视图+表情+细节+道具+动作](docs/images/showcase-seowon.png)
